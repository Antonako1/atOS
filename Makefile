...
.PHONY: all kernel bootloader iso clean run hdd help programs diskvbr clean_tap runn setup_tap test
.PHONY: run_user
.PHONY: run_user_gui
...
kernel: 
	...
	$(CComp) $(KRNLCompArgs) -c $(SOURCE_KERNEL_DIR)/32RTOSKRNL/DRIVERS/VESA/VESA.c -o $(OUTPUT_KERNEL_DIR)/VESA.o
	$(CComp) $(KRNLCompArgs) -c $(SOURCE_KERNEL_DIR)/32RTOSKRNL/DRIVERS/VESA/VBE.c -o $(OUTPUT_KERNEL_DIR)/VBE.o
...
# Link all object files into KRNL.BIN
	...
	$(CComp) $(RTOSKRNLCompArgs) -c $(SOURCE_KERNEL_DIR)/32RTOSKRNL/DRIVERS/VESA/VESA.c -o $(OUTPUT_KERNEL_DIR)/VESA.o
	$(CComp) $(RTOSKRNLCompArgs) -c $(SOURCE_KERNEL_DIR)/32RTOSKRNL/DRIVERS/VESA/VBE.c -o $(OUTPUT_KERNEL_DIR)/VBE.o
	$(CComp) $(RTOSKRNLCompArgs) -c $(SOURCE_KERNEL_DIR)/32RTOSKRNL/DRIVERS/PS2/KEYBOARD_MOUSE.c -o $(OUTPUT_KERNEL_DIR)/PS2_KEYBOARD_MOUSE.o
	...
	$(CComp) $(RTOSKRNLCompArgs) -c $(SOURCE_KERNEL_DIR)/32RTOSKRNL/CPU/YIELD/YIELD.c -o $(OUTPUT_KERNEL_DIR)/YIELD.o
	...
	$(CComp) -m32 -nostdlib -ffreestanding \
		...
		$(OUTPUT_KERNEL_DIR)/PS2_KEYBOARD_MOUSE.o \
...
iso: bootloader kernel programs diskvbr
	...
	cp -f $(SOURCE_DIR)/TSHELL.SH $(INPUT_ISO_DIR_SYSTEM)/TSHELL.SH
